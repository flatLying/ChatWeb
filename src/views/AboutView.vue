    ...
    <div class="main">
      ...
      <div class="loginbox">
          ...
          <div class="userbox"> 
           ...
           <input  class="user" id="user"   v-model="name" placeholder="手机号">
           </div>
          <br>
          <div class="pwdbox" v-if="loginFlag">
            <span class="iconfont">&#xe775;</span>
           <input  class="pwd" id ="password" type="password"  v-model="pwd" placeholder="密码">
           </div>

           <div class="pwdbox" v-else>
            <span class="iconfont">&#xe775;</span>
           <input  class="pwd" id ="password" type="password"  v-model="pwd" placeholder="验证码">
           </div>


          <br>
          <div class="log-box" v-if="loginFlag">
            <!-- <div class="log-box-text"> 验证码登录</div> -->
            <button type="primary"  class="register_btn" @click="codelogin">验证码登录</button>
           <button type="primary"  class="login_btn" @click="login">Login</button>
           </div>

           <div class="log-box" v-else>
            <!-- <div class="log-box-text"> 验证码登录</div> -->
            <button type="primary"  class="register_btn" @click="pwdlogin">密码登录</button>
           <button type="primary"  class="login_btn" @click="login">Login</button>
           </div>
           
           <br>
           <div class="warn">@HIT Dreamer</div>
           <button type="primary"  class="register_btn" @click="register">若无账号请点击注册</button>
     </div>
 
        <!-- 右侧的注册盒子 -->
         <div class="background">
            <div class="title">Welcome to Chatting Center</div>
        </div>
...
export default {
  ...
  methods:{
    pwdlogin(){this.loginFlag = true},
    codelogin(){ this.loginFlag = false},
    register(){  this.$router.push("signup")},
